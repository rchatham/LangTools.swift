...
actor TaskManager {
    ...
    private func createAgent(for type: AgentType) -> ChatCLIAgent {
        ChatCLIAgent(agentType: type)
    }
...
// MARK: - ChatCLI Agent Implementation

/// A ChatCLI-specific agent that wraps the Agent protocol
struct ChatCLIAgent: Agent {
